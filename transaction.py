...
def leave_transaction_management(exc_type=None, exc_value=None, tb=None,
        using=None):
    """
...
class Transaction(object):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        self.exiting(exc_type, exc_value, traceback, self.using)
...
def autocommit(using=None):
    ...
    def exiting(exc_type, exc_value, transaction, using):
        leave_transaction_management(exc_type, exc_value, transaction,
                using=using)
